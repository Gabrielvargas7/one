...
describe BookmarksCategoriesController do
  ...
  ##***********************************
  ## rspec test  #json_index_bookmarks_categories_by_item_id
  ##***********************************
    ...
    context "get a values " do
      it "should return json_show items designs  in json" do # depend on what you return in action
        ...
        body.each do |body_bk|
          @body_bk_json = BookmarksCategory.find(body_bk["id"])
          body_bk["id"].should == @body_bk_json.id
          body_bk["name"].should == @body_bk_json.name
