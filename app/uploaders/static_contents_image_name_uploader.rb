...
class StaticContentsImageNameUploader < CarrierWave::Uploader::Base
  ...
  process :tags => ['static_contents_image_name']
  ...
  def default_url
    asset_path("fallback/static_content/" + [version_name, "default.png"].compact.join('_'))
  end
