...
class BundlesImageUploader < CarrierWave::Uploader::Base
  ...
  include Sprockets::Helpers::IsolatedHelper
   ...
   #process :convert => 'png'
   process :tags => ['bundle_image_name']
  ...
  def default_url
    ...
    asset_path("fallback/bundle/" + [version_name, "default_bundle.png"].compact.join('_'))
  end
